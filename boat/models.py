...
class Boat(models.Model):
    ...
    manufacturer = models.CharField(max_length=64, choices=Manufacturer, default=Manufacturer.FAST, verbose_name=_('manufacturer'))
    model = models.CharField(max_length=64, blank=True, null=True)
    year_built = models.PositiveIntegerField(choices=YEAR_CHOICES, default=1970)
    share_owner_1 = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='share_owner_1', on_delete=models.SET_NULL, blank=True, null=True)
    share_owner_2 = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='share_owner_2', on_delete=models.SET_NULL, blank=True, null=True)
    share_owner_3 = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='share_owner_3', on_delete=models.SET_NULL, blank=True, null=True)
    share_owner_4 = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='share_owner_4', on_delete=models.SET_NULL, blank=True, null=True)
    share_owner_5 = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='share_owner_5', on_delete=models.SET_NULL, blank=True, null=True)
    share_owner_6 = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='share_owner_6', on_delete=models.SET_NULL, blank=True, null=True)
    share_owner_7 = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='share_owner_7', on_delete=models.SET_NULL, blank=True, null=True)
    share_owner_8 = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='share_owner_8', on_delete=models.SET_NULL, blank=True, null=True)
...
class BoatSection(models.Model):
